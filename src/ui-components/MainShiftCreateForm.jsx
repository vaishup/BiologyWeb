...
import { createMainShift } from "../graphql/mutations";
...
export default function MainShiftCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setShiftName(initialValues.shiftName);
    setDuties(initialValues.duties);
    setShiftDate(initialValues.shiftDate);
    setShiftStartTime(initialValues.shiftStartTime);
    setShiftEndTime(initialValues.shiftEndTime);
    setCreatedBy(initialValues.createdBy);
    setStartDate(initialValues.startDate);
    setEndDate(initialValues.endDate);
    setShiftstatus(initialValues.shiftstatus);
    setUserId(initialValues.userId);
    setStaffIds(initialValues.staffIds);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createMainShift.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MainShiftCreateForm")}
      {...rest}
    >
      <TextField
        label="Location id"
